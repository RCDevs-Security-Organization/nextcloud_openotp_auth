...
use OCA\OpenOTPAuth\Db\PublicKeyCredentialEntity;
...
use OCA\OpenOTPAuth\Repository\WebauthnPublicKeyCredentialSourceRepository;
...
class WebAuthnManager {
	public const TWOFACTORAUTH_WEBAUTHN_REGISTRATION = 'twofactorauth_openotp_regs';
	public const TWOFACTORAUTH_WEBAUTHN_REQUEST = 'twofactorauth_openotp_request';
	/**
	 * @var ISession
	 */
	private $session;
